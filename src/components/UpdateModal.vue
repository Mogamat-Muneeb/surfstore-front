      ...
      <div class="card">
        <Form @submit="updateProduct" :validation-schema="schema">
          <div class="form-group">
            ...
            <Field name="title" type="text" class="form-content" placeholder="title" :value="updateContent.title"/>
           
            <ErrorMessage name="title" class="error-feedback" />
          </div>
          <div class="form-group">
            <label for="category" style="padding-top:13px"></label>
            <Field name="category" as="select" class="form-content" placeholder="category" :value="updateContent.category">
          ...
          <div class="form-group">
            ...
            <Field name="description" type="text" class="form-content" placeholder="description" :value="updateContent.description"/>
           
            <ErrorMessage name="description" class="error-feedback" />
          </div>
          <div class="form-group">
            <label for="img" style="padding-top:13px"></label>
            <Field name="img" type="text" class="form-content" placeholder="img" :value="updateContent.img"/>
           
            <ErrorMessage name="img" class="error-feedback" />
          </div>
          <div class="form-group">
            <label for="price" style="padding-top:13px"></label>
            <Field name="price" type="text" class="form-content" placeholder="price" :value="updateContent.price"/>
